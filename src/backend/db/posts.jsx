...
export const posts = [
  ...
  },
  {
    _id: uuid(),
    content: {
      en: "Paws-itively Adorable: This cute little furball has mastered the art of melting hearts with its irresistible cuteness.",
      es: "Adorable con Patitas: Esta linda bolita de pelo ha dominado el arte de derretir corazones con su irresistible ternura.",
      fi: "Tassu-maisen Suloisaa: Tämä suloinen pieni karvapallon on hallinnut sydämien sulattamisen taiteen vastustamattomalla suloisuudellaan.",
      sr: "Šapa-tivno Očaravajuće: Ova slatka mala dlakava lopta je savladala umetnost topljenja srca svojom neodoljivom slatkoćom."
    },
    mediaUrl:
    ...
    comments: [
      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251365/socialMedia/profilePictures/user4_yobn9s.jpg",
        text: {
          en: "I can't handle the cuteness! Those big eyes and tiny paws are just too precious.",
          es: "¡No puedo con tanta ternura! Esos grandes ojos y patitas diminutas son demasiado preciosos.",
          fi: "En kestä tätä suloisuutta! Ne suuret silmät ja pienet tassut ovat liian arvokkaita.",
          sr: "Ne mogu da podnesem slatkoću! Te velike oči i sićušne šapice su previše dragocene."
        },
        votes: {
          upvotedBy: [
            {
      ...
      },
      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251365/socialMedia/profilePictures/user10_dmlsg2.jpg",
        text: {
          en: "I think my heart just melted! This kitty is so unbelievably cute, I can't even handle it.",
          es: "¡Creo que mi corazón se acaba de derretir! Este gatito es tan increíblemente lindo, ni siquiera puedo manejarlo.",
          fi: "Luulen että sydämeni juuri suli! Tämä kissanpentu on niin uskomattoman suloinen, etten edes voi käsitellä sitä.",
          sr: "Mislim da mi se srce upravo istopilo! Ova mačkica je tako neverovatno slatka, ne mogu je ni podneti."
        },
        votes: {
          upvotedBy: [
            {
...

  {
    _id: uuid(),
    content: {
      en: "Meow-mazing Moments: Cherishing every purrfect second with my adorable feline companion.",
      es: "Momentos Miau-ravillosos: Apreciando cada segundo purrfecto con mi adorable compañero felino.",
      fi: "Miau-htavia Hetkiä: Vaalimassa jokaista täydellistä sekuntia ihanan kissaseuralaiseni kanssa.",
      sr: "Mjau-čudesni Trenutci: Negujući svaki savršeni trenutak sa mojim obožavanim mačjim saputnikom."
    },
    mediaUrl:
    ...
    comments: [
      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251365/socialMedia/profilePictures/user4_yobn9s.jpg",
        text: {
          en: "This cat is a walking bundle of cuteness! I'm instantly smitten by its charm.",
          es: "¡Este gato es un paquete de ternura ambulante! Estoy instantáneamente cautivado por su encanto.",
          fi: "Tämä kissa on kävelevä suloisuuden nippu! Olen välittömästi lumoutunut sen viehätyksestä.",
          sr: "Ova mačka je hodajući paket slatkoće! Odmah sam očaran njenim šarmom."
        },
        votes: {
          upvotedBy: [
            {
...

  {
    _id: uuid(),
    content: {
      en: "Unleashing My Inner Artist: Transforming faces one brushstroke at a time, embracing the magic of makeup.",
      es: "Liberando Mi Artista Interior: Transformando rostros pincelada a pincelada, abrazando la magia del maquillaje.",
      fi: "Vapauttamassa Sisäistä Taiteilijaani: Muokkaamassa kasvoja yksi siveltimen veto kerrallaan, omaksuen meikin taikuutta.",
      sr: "Oslobađajući Mog Unutrašnjeg Umetnika: Transformišući lica jedan potez četkicom u isto vreme, prihvatajući magiju šminke."
    },
    mediaUrl:
    ...
    comments: [
      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251365/socialMedia/profilePictures/user4_yobn9s.jpg",
        text: {
          en: "Your makeup skills are absolutely mesmerizing! You've created a stunning masterpiece.",
          es: "¡Tus habilidades de maquillaje son absolutamente hipnotizantes! Has creado una obra maestra impresionante.",
          fi: "Meikkitaitosi ovat aivan lumovia! Olet luonut upean mestariteoksen.",
          sr: "Tvoje šminkerske veštine su apsolutno hipnotišuće! Napravila si zadivljujuće remek-delo."
        },
        votes: {
          upvotedBy: [
            {
      ...
      },
      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251368/socialMedia/profilePictures/user3_atvsaj.jpg",
        text: {
          en: "Your makeup game is on point! Flawless and fierce, you're slaying the beauty game.",
          es: "¡Tu juego de maquillaje está en su punto! Impecable y feroz, estás arrasando en el juego de belleza.",
          fi: "Meikkipelistäsi on täydellinen! Virheetön ja raivokas, hallitset kauneuspecliä.",
          sr: "Tvoja šminkarska igra je na mestu! Besprekorna i žestoka, osvaja lepotnu igru."
        },
        votes: {
          upvotedBy: [
            {
...

  {
    _id: uuid(),
    content: {
      en: "Beauty Brushstrokes: Enhancing confidence with a touch of artistry.",
      es: "Pinceladas de Belleza: Mejorando la confianza con un toque de arte.",
      fi: "Kauneuden Sivellintaitoa: Luottamusta lisäten taiteen läpileikkauksella.",
      sr: "Lepota četkicom: Pojačavanje samopouzdanja dodirom umetnosti."
    },
    mediaUrl:
    ...
    comments: [
      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251365/socialMedia/profilePictures/user4_yobn9s.jpg",
        text: {
          en: "Wow, your makeup skills are goals! Absolutely stunning transformation.",
          es: "¡Wow, tus habilidades de maquillaje son metas! Transformación absolutamente impresionante.",
          fi: "Vau, meikkitaitosi ovat tavoitteita! Aivan upea muodonmuutos.",
          sr: "Vau, tvoje šminkerske veštine su ciljevi! Apsolutno zadivljujuća transformacija."
        },
        votes: {
          upvotedBy: [
            {
      ...
      },
      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251368/socialMedia/profilePictures/user3_atvsaj.jpg",
        text: {
          en: "Flawless face, fierce vibes! Makeup game strong, you look amazing.",
          es: "Rostro impecable, vibraciones feroces! Juego de maquillaje fuerte, te ves increíble.",
          fi: "Virheetön kasvot, raivokkaat vibat! Meikkipeli vahva, näytät hämmästyttävältä.",
          sr: "Besprekorno lice, žestoke vibracije! Šminkarska igra jaka, izgledaš neverovatno."
        },
        votes: {
          upvotedBy: [
            {
...

  {
    _id: uuid(),
    content: {
      en: "Embracing Beauty's Symphony: Radiating confidence, grace, and the power of self-love.",
      es: "Abrazando la Sinfonía de la Belleza: Irradiando confianza, gracia y el poder del amor propio.",
      fi: "Kauneuden Sinfonia: Säteilevästi luottamusta, armoa ja itsensä rakkauden voimaa.",
      sr: "Prihvatajući Simfoniju Lepote: Zračeći samopouzdanjem, gracioznošću i snagom samoljublja."
    },
    mediaUrl:
    ...
    comments: [
      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251365/socialMedia/profilePictures/user4_yobn9s.jpg",
        text: {
          en: "You are a true beauty artist!.",
          es: "¡Eres una verdadera artista de la belleza!",
          fi: "Olet todellinen kauneudenhoitotaiteilija!",
          sr: "Ti si prava umetnica lepote!"
        },
        votes: {
          upvotedBy: [
            {
      ...
      },
      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251368/socialMedia/profilePictures/user3_atvsaj.jpg",
        text: {
          en: "Albsolutely gorgeous!",
          es: "¡Absolutamente hermosa!",
          fi: "Aivan upea!",
          sr: "Apsolutno predivna!"
        },
        votes: {
          upvotedBy: [
            {
...

  {
    _id: uuid(),
    content: {
      en: "Dribble, Shoot, Score: The rhythm of the game, the thrill of basketball.",
      es: "Driblar, Disparar, Anotar: El ritmo del juego, la emoción del baloncesto.",
      fi: "Kuljeta, Heitä, Pisteet: Pelin rytmi, koripallokiihko.",
      sr: "Driblaj, Šutni, Postizaj: Ritam igre, uzbuđenje košarke."
    },
    mediaUrl:
    ...
    comments: [
      {
        ...
        text: {
          en: "Swish! Your basketball skills are pure fire, amazing shot!",
          es: "¡Swish! Tus habilidades de baloncesto son puro fuego, ¡tiro increíble!",
          fi: "Swish! Koripallotaitosi ovat puhdasta tulta, mahtava heitto!",
          sr: "Sviš! Tvoje košarkaške veštine su čista vatra, neverovatno bacanje!"
        },
        votes: {
          upvotedBy: [
            {
...

  {
    _id: uuid(),
    content: {
      en: "Ballin' with Style: Hoop dreams in motion.",
      es: "Jugando con Estilo: Sueños de aro en movimiento.",
      fi: "Pelaamassa Tyylillä: Koriunelmia liikkeessä.",
      sr: "Košarka sa Stilom: Snovi o košu u pokretu."
    },
    mediaUrl:
    ...
    comments: [
      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251369/socialMedia/profilePictures/user7_eubrrf.jpg",
        text: {
          en: "Smooth moves on the court! Your basketball skills are on point.",
          es: "¡Movimientos suaves en la cancha! Tus habilidades de baloncesto están en su punto.",
          fi: "Sulavia liikkeitä kentällä! Koripallotaitosi ovat täydellisiä.",
          sr: "Glatki pokreti na terenu! Tvoje košarkaške veštine su na mestu."
        },
        votes: {
          upvotedBy: [
            {
...

  {
    _id: uuid(),
    content: {
      en: "Rhythm in Motion: Expressing through the art of dance.",
      es: "Ritmo en Movimiento: Expresándome a través del arte de la danza.",
      fi: "Rytmi Liikkeessä: Ilmaisten tanssin taiteen kautta.",
      sr: "Ritam u Pokretu: Izražavanje kroz umetnost plesa."
    },
    mediaUrl:
    ...
    comments: [
      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251369/socialMedia/profilePictures/user7_eubrrf.jpg",
        text: {
          en: "You've got moves! Your dancing is absolutely captivating. Keep grooving!",
          es: "¡Tienes movimientos! Tu baile es absolutamente cautivador. ¡Sigue bailando!",
          fi: "Sinulla on liikkeitä! Tanssisi on aivan lumoa. Jatka groovailua!",
          sr: "Imaš pokrete! Tvoj ples je apsolutno zadivljujući. Nastavi da plešeš!"
        },
        votes: {
          upvotedBy: [
            {
...

  {
    _id: uuid(),
    content: {
      en: "Finding Joy in Every Step: Dance like nobody's watching.",
      es: "Encontrando Alegría en Cada Paso: Baila como si nadie te viera.",
      fi: "Ilon Löytämistä Jokaisesta Askeleesta: Tanssi kuin kukaan ei katsoisi.",
      sr: "Pronalaženje Radosti u Svakom Koraku: Pleši kao da niko ne gleda."
    },
    mediaUrl:
    ...
    comments: [
...

      {
        ...
        text: {
          en: "You've got the dance floor on fire! Pure talent.",
          es: "¡Tienes la pista de baile en llamas! Talento puro.",
          fi: "Olet sytyttänyt tanssipatterin! Puhdasta lahjakkuutta.",
          sr: "Zapalio si plesnu pistu! Čisti talenat."
        },
        votes: {
          upvotedBy: [
            {
...

  {
    _id: uuid(),
    content: {
      en: "Embracing peace and strength through yoga.",
      es: "Abrazando la paz y la fuerza a través del yoga.",
      fi: "Omaksuen rauhaa ja voimaa joogan kautta.",
      sr: "Prihvatanje mira i snage kroz jogu."
    },
    mediaUrl:
    ...
    comments: [
      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251364/socialMedia/profilePictures/user2_dhebgg.jpg",
        text: {
          en: "Your yoga practice is inspiring and radiates inner tranquility. Namaste.",
          es: "Tu práctica de yoga es inspiradora e irradia tranquilidad interior. Namasté.",
          fi: "Joogaharjoituksesi on inspiroivaa ja säteilee sisäistä rauhaa. Namaste.",
          sr: "Tvoja joga praksa je inspirativna i zrači unutrašnjom mirnoćom. Namaste."
        },
        votes: {
          upvotedBy: [
            {
...

  {
    _id: uuid(),
    content: {
      en: "Flowing in Harmony: Balancing mind, body, and spirit through yoga.",
      es: "Fluyendo en Armonía: Equilibrando mente, cuerpo y espíritu a través del yoga.",
      fi: "Virtaamassa Harmoniassa: Tasapainottaen mielen, kehon ja hengen joogan kautta.",
      sr: "Protečnost u Skladu: Balansiranje uma, tela i duha kroz jogu."
    },
    mediaUrl:
    ...
    comments: [
...

      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251369/socialMedia/profilePictures/user6_ahdwkm.jpg",
        text: {
          en: "Yoga vibes on point! Keep rocking those poses.",
          es: "¡Vibraciones de yoga en su punto! Sigue dominando esas posturas.",
          fi: "Joogatunnelma täydellinen! Jatka näiden asantojen hallintaa.",
          sr: "Joga vibracije na mestu! Nastavi da rokaš te poze."
        },
        votes: {
          upvotedBy: [
            {
...

  {
    _id: uuid(),
    content: {
      en: "Building an unstoppable physique through dedication and sweat.",
      es: "Construyendo un físico imparable a través de la dedicación y el sudor.",
      fi: "Rakentamassa pysäyttämätöntä fysiikkaa omistautumisen ja hien kautta.",
      sr: "Gradnja nezaustavljivog fizičkog izgleda kroz posvećenost i znoj."
    },
    mediaUrl:
...

  {
    _id: uuid(),
    content: {
      en: "Nature's Artistry: Breathtaking landscapes that whisper serenity to the soul.",
      es: "El Arte de la Naturaleza: Paisajes impresionantes que susurran serenidad al alma.",
      fi: "Luonnon Taide: Henkeäsalpaavia maisemia, jotka kuiskivat rauhaa sielulle.",
      sr: "Umetnost Prirode: Zadivljujući predeli koji šaptu mirnoću duši."
    },
    mediaUrl:
    ...
    comments: [
      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251365/socialMedia/profilePictures/user10_dmlsg2.jpg",
        text: {
          en: "Nature's masterpiece, capturing the essence of pure tranquility and beauty.",
          es: "Obra maestra de la naturaleza, capturando la esencia de la pura tranquilidad y belleza.",
          fi: "Luonnon mestariteos, vangitsee puhtaan rauhan ja kauneuden olemuksen.",
          sr: "Remek-delo prirode, hvata suštinu čiste mirnoće i lepote."
        },
        votes: {
          upvotedBy: [
            {
    ...
    comments: [
      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251365/socialMedia/profilePictures/user10_dmlsg2.jpg",
        text: {
          en: "Nature's bliss captured perfectly.",
          es: "La dicha de la naturaleza capturada perfectamente.",
          fi: "Luonnon autuus vangittu täydellisesti.",
          sr: "Blaženstvo prirode savršeno uhvaćeno."
        },
        votes: {
          upvotedBy: [
            {
...

      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251368/socialMedia/profilePictures/user3_atvsaj.jpg",
        text: {
          en: "Pure beauty in every frame.",
          es: "Belleza pura en cada cuadro.",
          fi: "Puhdasta kauneutta jokaisessa kehyksessä.",
          sr: "Čista lepota u svakom kadru."
        },
        votes: {
          upvotedBy: [
            {
...

  {
    _id: uuid(),
    content: {
      en: "Nurturing the Soul: Connecting with the wonders of Mother Nature.",
      es: "Alimentando el Alma: Conectando con las maravillas de la Madre Naturaleza.",
      fi: "Sielun Ravitseminen: Yhdistäen luonnon äidin ihmeiden kanssa.",
      sr: "Negovanje Duše: Povezivanje sa čudesima Majke Prirode."
    },
    mediaUrl:
    ...
    comments: [
      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251365/socialMedia/profilePictures/user10_dmlsg2.jpg",
        text: {
          en: " This photo takes my breath away.",
          es: " Esta foto me quita el aliento.",
          fi: " Tämä kuva vie hengitykseni.",
          sr: " Ova fotografija mi oduzima dah."
        },
        votes: {
          upvotedBy: [
            {
...

      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251368/socialMedia/profilePictures/user3_atvsaj.jpg",
        text: {
          en: "What a stunning sight!",
          es: "¡Qué vista impresionante!",
          fi: "Mikä upea näky!",
          sr: "Kakav zadivljujući prizor!"
        },
        votes: {
          upvotedBy: [
            {
...

  {
    _id: uuid(),
    content: {
      en: " Indulging in the culinary delights of life.",
      es: " Deleitándome en las delicias culinarias de la vida.",
      fi: " Nautiskellen elämän kulinaarisista herkuista.",
      sr: " Uživanje u kulinskim čarolijama života."
    },
    mediaUrl:
...

  {
    _id: uuid(),
    content: {
      en: "Discovering the wonders that await.",
      es: "Descubriendo las maravillas que esperan.",
      fi: "Löytäen ihmetytyä odottavia ihmeita.",
      sr: "Otkrivanje čuda koja čekaju."
    },
    mediaUrl:
    ...
    comments: [
      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251367/socialMedia/profilePictures/user1_wla0x2.jpg",
        text: {
          en: "Wow, this photo truly captures the essence of the moment. Love it!",
          es: "Wow, esta foto realmente captura la esencia del momento. ¡Me encanta!",
          fi: "Vau, tämä kuva todella vangitsee hetken olemuksen. Rakastan sitä!",
          sr: "Vau, ova fotografija zaista hvata suštinu trenutka. Obožavam!"
        },
        votes: {
          upvotedBy: [
            {
...

  {
    _id: uuid(),
    content: {
      en: "Who wants some apples?",
      es: "¿Quién quiere manzanas?",
      fi: "Kuka haluaa omenoita?",
      sr: "Ko želi jabuke?"
    },
    mediaUrl:
    ...
    comments: [
      {
        ...
        avatarURL:
          "https://res.cloudinary.com/darwtgzlk/image/upload/w_400,f_auto,q_auto/v1686251367/socialMedia/profilePictures/user1_wla0x2.jpg",
        text: {
          en: "Wow, one for me please.",
          es: "Wow, una para mí por favor.",
          fi: "Vau, yksi minulle kiitos.",
          sr: "Vau, jednu za mene molim."
        },
        votes: {
          upvotedBy: [
            {
