  ...
  "messagesApp": {
    ...
    "messages": {
      "missionBrief": {
        ...
        "content": "Moderator,\n\nThe ECHO network has detected several suspicious users who could be bots spreading misinformation.\n\nYour mission is to analyze each profile and determine whether it's a bot or a real account. For each account you view, you must:\n\n1. Examine the profile\n2. Decide: Does this account seem like a bot?\n3. If you think it's a bot, explain why based on the indicators\n\n🔍 Before you start, review the bot account indicators. These will help you identify suspicious patterns.\n\nProtect the ECHO community by correctly identifying malicious accounts!"
      },
      "challenge2": {
